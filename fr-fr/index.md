...
Un réseau distribué pour la "Smart Economy"

## Les buts du design de NEO: Smart Economy

NEO est l'utilisation de la technologie blockchain et l'identité digitale pour digitaliser les assets, l'utilisation de smart contracts pour les assets digitaux pour être auto-géré, pour atteindre une "smart économy" avec un réseau distribué.

### Assets Digitaux

Les assets digitaux sont des assets programmable qui existent sous la forme de donnée électronique. Avec la technologie blochain, la digitalization des assets peut être décentralisé, trustful (??), très transparente, et libre d'intermédiaires. Sur la blockchain NEO, les utilisateurs peuvent s'inscrire, trader, et circulent multiple types d'assets.Prouvant la connexion entre assets digitaux et physiques est possible grâce à l'identité digitale. Les assets enregistrés via une identité digitale validé sont protogés par la loi.

-----
BELOW IS WHAT STILL NEEDS TO BE TRANSLATED
-----
