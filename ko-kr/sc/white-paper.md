...
크로스 도메인 요청은 네로컨트랙트로 하여금 풍부한 라이브러리 역량을 갖추게 해주는 데 이는 호출 계약에 대해 고도로 확장 
가능한 데이터 관리 능력을 제공합니다. 
...
대부분의 일회성 계약에 대해서는 실행비용이 10GAS미만인 경우에 무료로 실행되기 때문에 사용자는 비용을 상당히 아낄 수 
있습니다.
