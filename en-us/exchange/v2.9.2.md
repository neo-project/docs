...
| [ImportBlocks](https://github.com/neo-project/neo-plugins/releases/download/v2.9.2/ImportBlocks.zip) | Synchronizes the client using offline packages. This plug-in is included in the release package. | Mandatory for exchanges              |
...
1. Monitor new blocks through NEO-CLI  API ([getblock Method](../node/cli/2.9.2/api/getblock2.md)).
