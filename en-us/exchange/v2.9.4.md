...
> [!Note]
>
> This document provides information based on [Neo CLI v2.9.4](https://github.com/neo-project/neo-cli/releases/tag/v2.9.4). 
...
3. Install the ImportBlocks and ApplicationLogs plugins to get the complete functionality of transaction log API and automatic synchronization with the offline package. You can choose one of the following:
   ...
   - For all NEO-CLI versions：
     ...
     1. From GitHub download [ApplicationLogs](https://github.com/neo-project/neo-plugins/releases/download/v2.9.4/ApplicationLogs.zip) and [ImportBlocks](https://github.com/neo-project/neo-plugins/releases/download/v2.9.4/ImportBlocks.zip) in [Plugins](https://github.com/neo-project/neo-plugins/releases).
...
| 11   | Claim GAS.                                                   | `claim gas [all] [ChangeAddress]`               |
