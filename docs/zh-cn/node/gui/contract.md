...
2. 选择调用方法，并填写相应的参数。例如，要调用一个nep5标准中的transfer方法，填写如下参数：
   ...
   + `from`/ `to`：资产转出/转入地址。如果参数为地址，GUI支持三种数据类型的输入。

     + Address - 标准地址：`NiF41Z9YvLDp8apokQWYuMoXdrvbsuWpJV`
     + Hash160 - 大端序哈希：`0x0fe2945202205f9e18a4f9ff88d3a7d88eb2eef4`
     + ByteArray - Base64小端序哈希：`9O6yjtin04j/+aQYnl8gAlKU4g8=`
