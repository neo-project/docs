...
3. 从 GitHub 上下载 [Plugins](https://github.com/neo-project/neo-plugins/releases) 中的 [ApplicationLogs](https://github.com/neo-project/neo-plugins/releases/download/v2.9.3/ApplicationLogs.zip) 和 [ImportBlocks](https://github.com/neo-project/neo-plugins/releases/download/v2.9.3/ImportBlocks.zip) 以保证交易日志 API 和自动读取离线包的完整性。
...
5. 在启动 NEO-CLI 前需先配置 config.json 文件中的以下参数：
