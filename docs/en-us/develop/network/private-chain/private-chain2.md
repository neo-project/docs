...
Download [DBFTPlugin]("https://github.com/neo-project/neo-modules/releases/download/v3.0.0/DBFTPlugin.zip") and place four copies to the `Plugins` folder under each node CLI root path. Modify the file `config.json` as follows：
