...
> **Changes in NEO3**：
>
> Invocation style updated: getblockheader, getrawmempool
>
> Returns updated: getblock, getblockheader, getrawtransaction, getversion, and getcontractstate
...
### Methods in RpcWallet plugin

The following table lists all the wallet-related methods provided by the plugin [RpcWallet](https://github.com/neo-project/neo-plugins/releases) . You need to install the plugin and open a wallet before invoking them.
