...
| [getmetricblocktimestamp](getmetricblocktimestamp.md) | \<blocks numbers>  \<endHeight> | 返回指定区块高度及之前 n 个区块的 timestamp。 | |
...
| [getunclaimed](getunclaimed.md) | \<address> | 返回地址中未提取的 GAS 数量。 | |
| [getunclaimedgas](api/getunclaimedgas.md) | | 显示钱包中未提取的 GAS 数量。 | 需要打开钱包 |
| [getunspents](getunspents.md) | \<address> | 返回指定账户中未花费的 UTXO 资产信息。 |  |
