...
> [!Note]
>
> neo-cli 钱包支持两种格式的钱包，一种是一直使用的 SQLLite 钱包（格式为 .db3），另一种是新支持的 [NEP6 标准](https://github.com/neo-project/proposals/blob/master/nep-6.mediawiki) 钱包（格式为 .json）。建议交易所使用 SQLLite 钱包。
