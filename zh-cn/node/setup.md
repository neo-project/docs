...
上文介绍了 NEO 的全节点有两个客户端，一个是 [Neo-CLI](https://github.com/neo-project/neo-gui/releases)（为开发者提供的命令行客户端），一个是 [Neo-GUI](https://www.neo.org/download)（为高级用户提供的图形界面的客户端）
...
1、在 Github 上下载 [Neo-CLI](https://github.com/neo-project/neo-gui/releases) 程序包并解压。
