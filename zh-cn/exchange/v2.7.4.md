...
> [!Note]
>
> 本文对应neo-cli版本为 [Neo CLI v2.7.4](https://github.com/neo-project/neo-cli/releases/tag/v2.7.4)
...
4. 使用NEO-CLI API 中的 `sendtoaddress <asset_id> <address> <value>` 方法 ，向用户提现地址发送交易。更多信息，请参阅 [sendtoaddress方法](../node/cli/latest-version/api/sendtoaddress.md)。
