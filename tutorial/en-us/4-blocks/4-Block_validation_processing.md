...
When we look at the block with height 3,649,960, which was introduced in [Part 2, Structure of a block](2-Structure_of_a_block.md), we can identify these 2 scripts in the field "script." It is repeated below for convenience:
```
"script": {
