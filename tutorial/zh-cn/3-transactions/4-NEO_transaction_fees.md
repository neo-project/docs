...
对于大小超过1024字节的交易需要支付0.001 GAS的基础费用，超过1024字节的部分按每字节0.00001 GAS收取网络费用。大多数基本的NEP-5资产转账交易大小仍然是远低于1024字节的，但是逻辑更复杂或者有大量[输入](2-Structure_of_NEO_transactions.md#inputs)和[输出](2-Structure_of_NEO_transactions.md#outputs)的交易可能会超过这一阈值因此需要支付一定的网络费用。
...
[阅读下一章](../4-blocks/1-Introduction_to_blocks_and_blockchain.md) 或 [返回目录](../index.md)  
