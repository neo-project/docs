...
Il dBFT provvede una tolleranza ai guasti di f = ⌊ (n-1) / 3 ⌋ per un sistema di consenso costituito da n nodi. Questa tolleranza ai guasti include entrambe sicurezza e disponibilità, resistente ai fallimenti generali e relativi al Byzantine, inoltre adatto a qualsiasi ambiente di rete. Il dBFT é "inamovibile", ciò significa che una volta che le conferme sono definitive, il blocco non può più essere forkato, e le transazioni non possono essere revocate o reimpostate allo stato precedente.
