...
<b>Figura 5:</b> *Simulação de Monte Carlo do DBFT com uma população de 100 Nós; 100.000 blocos simulados (ou seja, versões da verdade simuladas) e seleção aleatória de nós honestos*</p>
