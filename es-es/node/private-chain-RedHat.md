# Creación de una blockchain privada en RedHat
...
| -------------- | ---------------- | ----------------- |--------------|
| **privatechain1**  | privatechain1.neolab.local  | RHEL 7.4 | neo-cli - privatechain1.db3 |
| **privatechain2**  | privatechain2.neolab.local  | RHEL 7.4 | neo-cli - privatechain2.db3 |
| **privatechain3**  | privatechain3.neolab.local  | RHEL 7.4 | neo-cli - privatechain3.db3 |
| **privatechain4**  | privatechain4.neolab.local  | RHEL 7.4 | neo-cli - privatechain4.db3 |
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_1.png">
...
><img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_2.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_3.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_4.png">
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_5.png">
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_6.png">
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_7.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_8.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_10.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_11.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_12.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_13.png">

Una vez recreados los índices aparecerá la dirección de contrato con 100 millones de NEOs.

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_14.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_15.png">

El sistema mostrará el siguiente mensaje `Transaction initiated, but the signature is incompleted`. 

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_16.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_17.png">

Pega el codigo que anteriormente has copiado. Click `Signature` y vuelte a copiar el codigo de salida `Output`, click en `Copy`

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_18.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_19.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_20.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_21.png">

Click en `Claim All`

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_22.png">

Una vez pulsado del botón `Claim All`. Nos aparecerá el siguiente mensaje:

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_23.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_24.png">
...
<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_25.png">

Una vez recreado los indices veremos los NeoGas.

<img style="vertical-align: middle" src="assets/privatechain-rhel//privatechain_26.png">
