# Creación de una blockchain privada en Ubuntu
...
| -------------- | ---------------- | ----------------- |--------------|
| **privatechain1**  | privatechain1.neolab.local  | Ubuntu 16.04.3 LTS | neo-cli - privatechain1.db3 |
| **privatechain2**  | privatechain2.neolab.local  | Ubuntu 16.04.3 LTS | neo-cli - privatechain2.db3 |
| **privatechain3**  | privatechain3.neolab.local  | Ubuntu 16.04.3 LTS | neo-cli - privatechain3.db3 |
| **privatechain4**  | privatechain4.neolab.local  | Ubuntu 16.04.3 LTS | neo-cli - privatechain4.db3 |
| **neoscan**  | neoscan.neolab.local        | Ubuntu 16.04.3 LTS        |Opcional| 
...
> [!IMPORTANT] 
>Despues de crear las máquinas virtuales abre los puertos 10331-10334 en el firewall de Ubuntu via `ufw/iptables` y establece nuevas reglas de entrada para los puertos 10331-10334.
